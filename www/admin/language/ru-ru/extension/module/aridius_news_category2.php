<?php
// Heading
$_['heading_title']     = 'Aridius (Modern) &nbsp;<strong style = "color: #BAA063;">Список статьей</strong>';

// Text
$_['text_module']       = 'Модули';
$_['text_success']      = 'Настройки модуля обновлены!';
$_['text_edit']         = 'Редактирование модуля';
$_['text_all']          = 'Выделить все статьи';
$_['text_dell']         = 'Убрать все статьи';
...
$_['entry_category']    = 'Выберите какие статьи будут отображаться';
