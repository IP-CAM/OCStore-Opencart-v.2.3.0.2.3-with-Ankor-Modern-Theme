...
<?php foreach ($news as $new) { ?>
   ...
   <td class="checkbox">
   <label>
	<?php if (in_array($new['aridius_news_id'], $aridius_news_category2)) { ?>
		<input type="checkbox" name="aridius_news_category2[]" value="<?php echo $new['aridius_news_id']; ?>" checked="checked" />
		<?php echo $new['title']; ?>
		<?php } else { ?>
		<input type="checkbox" name="aridius_news_category2[]" value="<?php echo $new['aridius_news_id']; ?>" />
		<?php echo $new['title']; ?>
		<?php } ?>
	</label>
    </td>
