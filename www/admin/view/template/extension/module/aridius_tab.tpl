...
<button type="submit" form="form-aridiusproducttab" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i>&nbsp;&nbsp;<?php echo $button_save; ?></button>
...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-aridiusproducttab" class="form-horizontal">
...
<script type="text/javascript"><!--
function apply() {
	$('#form-aridiusproducttab').append('<input type="hidden" id="apply" name="apply" value="1" />');
	$('#form-aridiusproducttab').submit();
}
//--></script>
<?php echo $footer; ?>