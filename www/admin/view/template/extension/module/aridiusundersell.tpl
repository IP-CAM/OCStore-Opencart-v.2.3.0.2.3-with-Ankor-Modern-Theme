...
<a href="<?php echo $aridiusundersell; ?>" data-toggle="tooltip" title="<?php echo $text_aridiusundersell; ?>" class="btn btn-default"><i class="fa fa-shopping-cart"></i></a>        
<button type="submit" form="form-undersell" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>   
