...
<?php foreach ($news as $new) { ?>
   ...
   <td class="checkbox">
   <label>
	<?php if (in_array($new['aridius_news_id2'], $aridius_news_category2)) { ?>
		<input type="checkbox" name="aridius_news_category2[]" value="<?php echo $new['aridius_news_id2']; ?>" checked="checked" />
		<?php echo $new['title']; ?>
		<?php } else { ?>
		<input type="checkbox" name="aridius_news_category2[]" value="<?php echo $new['aridius_news_id2']; ?>" />
		<?php echo $new['title']; ?>
		<?php } ?>
	</label>
    </td>
...
<div class="form-group">
<label class="col-sm-2 control-label" for="height"><?php echo $entry_height; ?></label>
<div class="col-sm-10">
