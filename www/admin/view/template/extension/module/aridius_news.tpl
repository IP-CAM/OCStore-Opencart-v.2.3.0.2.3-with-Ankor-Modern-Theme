...
<a href="<?php echo $aridius_news; ?>" data-toggle="tooltip" title="<?php echo $button_news; ?>" class="btn btn-primary"><i class="fa fa-plus"></i> <?php echo $button_news; ?></a>
...
<div class="col-sm-10"><a href="" id="thumb-footerback" data-toggle="image" class="img-thumbnail"><img src="<?php echo $aridius_news_footerback; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
<input type="hidden" name="aridius_news_footer_back" value="<?php echo $aridius_news_footer_back; ?>" id="input-footerback" />
</div>
</div>
<div class="form-group">
