...
<button type="submit" form="form-featured" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i>&nbsp;&nbsp;<?php echo $button_save; ?></button>
...
<script type="text/javascript"><!--
function apply() {
	$('#form-featured').append('<input type="hidden" id="apply" name="apply" value="1" />');
