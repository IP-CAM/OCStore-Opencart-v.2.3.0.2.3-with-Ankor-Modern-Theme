<?
/**
 * @var \app\models\Callback[] $callList
 */
?>
...
<!--                                            --><?php //} ?>
                                        ...
                                        <? $edit = $controller->url->link('catalog/callback/edit', 'token=' . $controller->session->data['token'] . '&id=' . $item->id, true)?>
                                        <? $delete = $controller->url->link('catalog/callback/delete', 'token=' . $controller->session->data['token'] . '&id=' . $item->id, true)?>
                                        <td class="text-right">
