...
<td class="right"><?php if ($sort == 'status') { ?>
	...
	<?php } ?></td>	
<td class="right"><?php echo $text_time; ?></td>	
...
<?php if ($orders) { ?>
	<?php foreach ($orders as $order) { ?>
		...
		<td class="text-left"><?php echo $order['time_in']; ?> - <?php echo $order['time_off']; ?></td>
...
function filter() {
	url = 'index.php?route=catalog/aridiuscallback&token=<?php echo $token; ?>';
