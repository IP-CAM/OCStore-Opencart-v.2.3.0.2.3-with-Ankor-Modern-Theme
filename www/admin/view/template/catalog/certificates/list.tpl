<?
/**
 * @var \app\models\Certificate[] $items
 */
?>
                            ...
                            <?if ($items):?>
                                ...
                                <?foreach ($items as $item):?>
                                    <tr class="<?php echo $class; ?>">
                                        ...
                                        <? $edit = $controller->url->link('catalog/certificates/edit', 'token=' . $controller->session->data['token'] . '&id=' . $item->id, true)?>
                                        <? $delete = $controller->url->link('catalog/certificates/delete', 'token=' . $controller->session->data['token'] . '&id=' . $item->id, true)?>
                                        <td class="text-right">
