...
<div class="form-group">
<label class="col-sm-2 control-label" for="input-comment_manager"><?php echo $text_comment_manager; ?></label>
<div class="col-sm-10">
...
source: function(request, response) {
		$.ajax({
url: 'index.php?route=catalog/aridiusinstock/autocomplete&token=<?php echo $token; ?>&filter_product_name=' +  encodeURIComponent(request.term),
dataType: 'json',
