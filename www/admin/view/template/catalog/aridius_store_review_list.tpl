        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <button type="button" id="button-filter-store" class="btn btn-primary pull-right"><i class="fa fa-search"></i> <?php echo $button_filter; ?></button>
            </div>
          </div>
        </div>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'author') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'rating') { ?>
...
$('#button-filter-store').on('click', function() {
	url = 'index.php?route=catalog/aridius_store_review&token=<?php echo $token; ?>';
