  ...
  <div class="page-header">
    <div class="container-fluid">
	  ...
	  <a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-review-store').submit() : false;"><i class="fa fa-trash-o"></i></button>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label class="control-label" for="input-news"><?php echo $entry_news; ?></label>
                <input type="text" name="filter_news" value="<?php echo $filter_news; ?>" placeholder="<?php echo $entry_news; ?>" id="input-news" class="form-control" />
              </div>
              <div class="form-group">
            ...
            <div class="col-sm-6">
              ...
              <button type="button" id="button-filter-qa" class="btn btn-primary pull-right"><i class="fa fa-search"></i> <?php echo $button_filter; ?></button>
            </div>
          </div>
        </div>
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-review-store">
...
$('#button-filter-qa').on('click', function() {
	url = 'index.php?route=catalog/aridius_review_news2&token=<?php echo $token; ?>';
