...
/**
 * @var \app\models\AnkorRedirect $item
 */
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab-general">
								...
								<div class="form-group">
									<?=Form::label('Ссылка','link',['class'=>'col-sm-2 control-label']);?>
									<div class="col-sm-10">
										<?=Form::text('link',$item->link,['class'=>'form-control'])?>
									</div>
								</div>
								<div class="form-group">
									<?=Form::label('Перенаправление','redirect',['class'=>'col-sm-2 control-label']);?>
									<div class="col-sm-10">
										<?=Form::text('redirect',$item->redirect,['class'=>'form-control'])?>
									</div>
								</div>
