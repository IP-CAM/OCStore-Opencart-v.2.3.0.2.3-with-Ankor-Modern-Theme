<?
/**
 * @var \app\models\AnkorRedirect[] $items
 */
?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="center">Перенаправление</td>
                            ...
                            <?if ($items):?>
                                ...
                                <?foreach ($items as $item):?>
                                    <tr class="<?php echo $class; ?>">
                                        ...
                                        <? $edit = $controller->url->link('catalog/ankor_redirect/edit', 'token=' . $controller->session->data['token'] . '&id=' . $item->id, true)?>
                                        <? $delete = $controller->url->link('catalog/ankor_redirect/delete', 'token=' . $controller->session->data['token'] . '&id=' . $item->id, true)?>
                                        <td class="text-right">
