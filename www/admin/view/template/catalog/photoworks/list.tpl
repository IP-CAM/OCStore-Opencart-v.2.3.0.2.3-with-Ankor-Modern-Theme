<?
/**
 * @var \app\models\Photowork[] $items
 */
?>
                            ...
                            <?if ($items):?>
                                ...
                                <?foreach ($items as $item):?>
                                    <tr class="<?php echo $class; ?>">
                                        ...
                                        <? $edit = $controller->url->link('catalog/photoworks/edit', 'token=' . $controller->session->data['token'] . '&id=' . $item->id, true)?>
                                        <? $delete = $controller->url->link('catalog/photoworks/delete', 'token=' . $controller->session->data['token'] . '&id=' . $item->id, true)?>
                                        <td class="text-right">
