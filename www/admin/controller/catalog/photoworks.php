...
class ControllerCatalogPhotoworks extends Controller {
    ...
    protected function redirectToEdit(){
        ...
        if (isset( $this->request->get['id'])) {
            ...
            $this->response->redirect($this->url->link('catalog/photoworks/edit', $params , true));
        }else {
            $this->response->redirect($this->url->link('catalog/photoworks', $params , true));
        }
	...
	public function delete() {
		...
		if (!empty($selected) && $this->validateDelete()) {
			...
			$this->response->redirect($this->url->link('catalog/photoworks', 'token=' . $this->session->data['token'] . $url, true));
		}
		$this->getList();
	}
	...
	private function getList() {
        ...
        $data['add'] = $this->url->link('catalog/photoworks/add', 'token=' . $this->session->data['token'], true);
        $data['delete'] = $this->url->link('catalog/photoworks/delete', 'token=' . $this->session->data['token'], true);
        $data['setting'] = $this->url->link('catalog/photoworks/setting', 'token=' . $this->session->data['token'], true);

        $data['items'] = Photowork::getListAdmin($data);
        ...
        $this->response->setOutput($this->load->view('catalog/photoworks/list', $data));
	...
	private function getPagination($total) {
        ...
        $pagination->url = $this->url->link('catalog/photoworks', 'token=' . $this->session->data['token'] . '' . '&page={page}', true);
	...
	private function getForm() { 
        ...
        if (!isset($this->request->get['id'])) {
            $data['action'] = $this->url->link('catalog/photoworks/add', 'token=' . $this->session->data['token'], true);
        } else {
            $data['action'] = $this->url->link('catalog/photoworks/edit', 'token=' . $this->session->data['token'] . '&id=' . $this->request->get['id'], true);
        }
		...
		$this->response->setOutput($this->load->view('catalog/photoworks/form', $this->data));
...
//		$this->load->model('catalog/photoworks');
	...
	protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'catalog/photoworks')) {
