...
class ControllerCatalogaridiuscallback extends Controller {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/aridiuscallback', 'token=' . $this->session->data['token'] . $url, true));
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/aridiuscallback', 'token=' . $this->session->data['token'], true)
		);

		$data['cancel'] = $this->url->link('extension/module/aridiuscallback', 'token=' . $this->session->data['token'], true);
		...
		if (isset($this->request->get['page'])) {
			...
			$data['delete'] = $this->url->link('catalog/aridiuscallback/delete', 'token=' . $this->session->data['token'] . $url, true);
			...
			foreach ($results as $result) {
				...
				$action[] = array(
					...
					'href' => $this->url->link('catalog/aridiuscallback/delete', 'token=' . $this->session->data['token'] . $url, true),
				);
				...
				$data['orders'][] = array(
					...
					'action' => $action,
	                'edit'       => $this->url->link('catalog/aridiuscallback/edit', 'token=' . $this->session->data['token'] . '&order_id=' . $result['order_id'] . $url, true),			
				);
			}
			...
			$data['sort_order'] = $this->url->link('catalog/aridiuscallback', 'token=' . $this->session->data['token'] . '&sort=order_id' . $url, true);
			$data['sort_status'] = $this->url->link('catalog/aridiuscallback', 'token=' . $this->session->data['token'] . '&sort=status' . $url, true);
			$data['sort_email'] = $this->url->link('catalog/aridiuscallback', 'token=' . $this->session->data['token'] . '&sort=email' . $url, true);
			$data['sort_contact'] = $this->url->link('catalog/aridiuscallback', 'token=' . $this->session->data['token'] . '&sort=contact' . $url, true);
	    	$data['sort_firstname'] = $this->url->link('catalog/aridiuscallback', 'token=' . $this->session->data['token'] . '&sort=firstname' . $url, true);	
	        $data['sort_comment'] = $this->url->link('catalog/aridiuscallback', 'token=' . $this->session->data['token'] . '&sort=comment' . $url, true);	

			$data['sort_total'] = $this->url->link('catalog/aridiuscallback', 'token=' . $this->session->data['token'] . '&sort=total' . $url, true);
			$data['sort_date_added'] = $this->url->link('catalog/aridiuscallback', 'token=' . $this->session->data['token'] . '&sort=date_added' . $url, true);
		    ...
		    $pagination->url = $this->url->link('catalog/aridiuscallback', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('catalog/aridiuscallback', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['action'] = $this->url->link('catalog/aridiuscallback/edit', 'token=' . $this->session->data['token'] . '&order_id=' . $this->request->get['order_id'] . $url, true);
		$data['cancel'] = $this->url->link('catalog/aridiuscallback', 'token=' . $this->session->data['token'] . $url, true);
