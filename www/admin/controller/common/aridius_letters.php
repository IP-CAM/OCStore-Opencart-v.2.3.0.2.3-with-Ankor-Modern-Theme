...
class ControllerCommonAridiusletters extends Controller {
	...
	public function delete() {
		...
		$this->response->redirect($this->url->link('common/aridius_letters', 'token=' . $this->session->data['token'] . $url, true));
	...
	protected function getList() {
		...
		$data['cancel'] = $this->url->link('extension/module/aridius_letters', 'token=' . $this->session->data['token'] . $url, true);
		...
		$url = '';
		$data['delete'] = $this->response->redirect($this->url->link('common/aridius_letters', 'token=' . $this->session->data['token'] . $url, true));
        }

		$data['delete'] = $this->url->link('common/aridius_letters/delete', 'token=' . $this->session->data['token'], true);
		...
		$data['button_dell'] = $this->language->get('button_dell');	
		$data['text_id'] = $this->language->get('text_id');	
		$data['text_email'] = $this->language->get('text_email');	
		$data['text_date'] = $this->language->get('text_date');	
		$data['text_confirm'] = $this->language->get('text_confirm');	
		$data['text_filter'] = $this->language->get('text_filter');	
		$data['text_emailform'] = $this->language->get('text_emailform');
		$data['text_sendemail'] = $this->language->get('text_sendemail');
		...
		$pagination->url = $this->url->link('common/aridius_letters', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
