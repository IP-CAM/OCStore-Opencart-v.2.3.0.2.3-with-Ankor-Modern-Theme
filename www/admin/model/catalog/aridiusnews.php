...
class ModelCatalogAridiusNews extends Model {
	...
	public function addaridius_news($data) {
		...
		if (isset($data['video'])) {
			$this->db->query("UPDATE " . DB_PREFIX . "aridius_news SET video = '" . $this->db->escape($data['video']) . "' WHERE aridius_news_id = '" . (int)$aridius_news_id . "'");
		}
		...
		if ($data['keyword']) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "url_alias SET query = 'aridius_news_id=" . (int)$aridius_news_id . "', keyword = '" . $this->db->escape($data['keyword']) . "'");
		}
	...
	public function editaridius_news($aridius_news_id, $data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "url_alias WHERE query = 'aridius_news_id=" . (int)$aridius_news_id . "'");
	...
	public function getaridius_newsStory($aridius_news_id) {
		...
		$query = $this->db->query("SELECT DISTINCT *, (SELECT keyword FROM " . DB_PREFIX . "url_alias WHERE query = 'aridius_news_id=" . (int)$aridius_news_id . "') AS keyword FROM " . DB_PREFIX . "aridius_news n LEFT JOIN " . DB_PREFIX . "aridius_news_description nd ON (n.aridius_news_id = nd.aridius_news_id) WHERE n.aridius_news_id = '" . (int)$aridius_news_id . "' AND nd.language_id = '" . (int)$this->config->get('config_language_id') . "'");
