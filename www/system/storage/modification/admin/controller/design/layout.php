...
class ControllerDesignLayout extends Controller {
	...
	protected function getForm() {
		...
		$data['text_column_right'] = $this->language->get('text_column_right');
					...
					$data['text_content_top1']   = $this->language->get('text_content_top1');		
					$data['text_content_top2']   = $this->language->get('text_content_top2');	
					$data['text_content_bot1']   = $this->language->get('text_content_bot1');	
					$data['text_content_bot2']   = $this->language->get('text_content_bot2');	
					$data['text_content_bot3']   = $this->language->get('text_content_bot3');			
					$data['text_content_fluid']  = $this->language->get('text_content_fluid');	
					$data['text_content_slleft'] = $this->language->get('text_content_slleft');	
					$data['text_content_mail']   = $this->language->get('text_content_mail');	
