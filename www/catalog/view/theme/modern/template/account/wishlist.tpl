          ...
          <tbody>
            ...
            <tr>
			 ...
			 <td class="text-right">
				...
				<button type="button" class="btn btn-primary" onclick="instock.add('<?php echo $product['product_id']; ?>');" data-product-id="<? echo $product['product_id']; ?>"><i class="fa fa-send-o"></i></button>
