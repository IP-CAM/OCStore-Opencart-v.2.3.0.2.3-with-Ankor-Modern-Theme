...
<div id="featured_carusel<?php echo $module; ?>" class="owl-carousel">
<?php foreach ($products as $key => $product) { ?>
	<div class="product-layoutcatnew">
	<div class="border product-thumb">
	<div id="imgCarousel-featured<?php echo $key ?>" class="carousel slide" data-ride="carousel">
	...
	<?php $html = '';?>
	<?php $img_key = 1;?>
	<?php $html .= '<li data-target="#imgCarousel-featured' . $key . '" data-slide-to="0" class="active"></li>'; ?>
	<?php foreach ($product['images'] as $image) { ?>
		...
		<?php $html .= '<li data-target="#imgCarousel-featured' . $key . '" data-slide-to="' . $img_key . '"></li>'; ?>
		<?php $img_key++ ;?>
		<?php } ?>
	<?php if ($img_key > 1) { ?>
		...
		<a class="left carousel-control" href="#imgCarousel-featured<?php echo $key ?>" role="button" data-slide="prev">
		<i class="fa fa-caret-left"></i>
		</a>
		<a class="right carousel-control" href="#imgCarousel-featured<?php echo $key ?>" role="button" data-slide="next">
	...
	<script>
	$('#imgCarousel-featured<?php echo $key ?>').carousel({
    interval: false
	})
	</script>
...
$('#featured_carusel<?php echo $module; ?>').owlCarousel({
