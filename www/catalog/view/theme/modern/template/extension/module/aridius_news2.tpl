<?php if ($aridius_news2) { ?>
	...
	<?php foreach ($aridius_news2 as $aridius_news_story) { ?>
		...
		<?php if ($aridius_news_story['video']) { ?>
			...
			<?php if ($str) { ?>
				...
				<?php if ($str_end) { ?>
					...
					<?php } ?>
				<?php } ?>
			<div class="grid-aridius_news2 video video_news">
			<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/<?php echo $id_video; ?>" allowfullscreen></iframe>
			</div>
			<?php } ?>
		<?php if ($aridius_news_story['image'] && !$aridius_news2_show_img && !$aridius_news_story['video']) { ?>
			<div class="grid-aridius_news2 col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<a href="<?php echo $aridius_news_story['href']; ?>" title="<?php echo $aridius_news_story['title']; ?>"><img class="img-responsive aridius_news2-hover" src="<?php echo $aridius_news_story['image']; ?>" alt="<?php echo $aridius_news_story['title']; ?>" /></a>
			</div>
			<?php } ?>
		<?php if (!$aridius_news2_show_date) { ?>
			<p> <i class="fa fa-clock-o"></i> <span class="posted-aridius_news2"><?php echo $aridius_news_story['posted']; ?></span></p>
			<?php } ?>
		...
		<?php if (!$aridius_news2_show_description) { ?>
			<div class="description-aridius_news2">
