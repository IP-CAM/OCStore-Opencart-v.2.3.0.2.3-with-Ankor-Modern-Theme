...
<div id="special_carusel<?php echo $module; ?>" class="owl-carousel">
<?php foreach ($products as $key => $product) { ?>
	<div class="product-layoutcatnew">
	<div class="border product-thumb">
	<div id="imgCarousel-special<?php echo $key ?>" class="carousel slide" data-ride="carousel">
	...
	<?php $html = '';?>
	<?php $img_key = 1;?>
	<?php $html .= '<li data-target="#imgCarousel-special' . $key . '" data-slide-to="0" class="active"></li>'; ?>
	<?php foreach ($product['images'] as $image) { ?>
		...
		<?php $html .= '<li data-target="#imgCarousel-special' . $key . '" data-slide-to="' . $img_key . '"></li>'; ?>
		<?php $img_key++ ;?>
		<?php } ?>
	<?php if ($img_key > 1) { ?>
		...
		<a class="left carousel-control" href="#imgCarousel-special<?php echo $key ?>" role="button" data-slide="prev">
		<i class="fa fa-caret-left"></i>
		</a>
		<a class="right carousel-control" href="#imgCarousel-special<?php echo $key ?>" role="button" data-slide="next">
	...
	<script>
	$('#imgCarousel-special<?php echo $key ?>').carousel({
    interval: false
	})
	</script>
	...
	<?php if ($product['special_date_end'] > $product['special_date_start']) { ?>
...
$('#special_carusel<?php echo $module; ?>').owlCarousel({
