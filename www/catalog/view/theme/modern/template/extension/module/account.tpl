<div class="list-group">
  ...
  <?php } ?>
  <a href="<?php echo $address; ?>" class="list-group-item"><?php echo $text_address; ?></a> </a> <a href="<?php echo $order; ?>" class="list-group-item"><?php echo $text_order; ?> <a href="<?php echo $newsletter; ?>" class="list-group-item"><?php echo $text_newsletter; ?></a>
  <?php if ($logged) { ?>
