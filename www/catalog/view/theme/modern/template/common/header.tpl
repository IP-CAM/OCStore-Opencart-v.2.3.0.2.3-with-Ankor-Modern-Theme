...
<head>
    ...
    <style>
        <?php echo $modern_css; ?>
        .back_news {
        <?php if (empty($footer_back)) { ?> background: #<?php echo $modern_main_background_color ?>;
        <?php } else { ?> background: url('<?php echo $footer_back; ?>');
        <?php } ?>
        }

        .back_articles {
        <?php if (empty($footer_back2)) { ?> background: #<?php echo $modern_main_background_color ?>;
        <?php } else { ?> background: url('<?php echo $footer_back2; ?>');
        <?php } ?>
        }

        .form_mail {
        <?php if (empty($letters_back)) { ?> background: #<?php echo $modern_main_background_color ?>;
        <?php } else { ?> background: url('<?php echo $letters_back; ?>');
        <?php } ?>
        }
        ...
        <div class="container nobackground">
            ...
            <div id="top-links2" class="nav pull-left">
                <ul class="list-inline top">
                    <?php if ($modern_wishlist_top != 1) { ?>
                        <li class="marg_link"><a href="<?php echo $wishlist; ?>" id="wishlist-total"
                                                 title="<?php echo $text_wishlist; ?>"><i
                                class="fa fa-heart hidden-lg hidden-md"></i> <span
                                class="hidden-xs hidden-sm "><?php echo $text_wishlist; ?></span></a></li><?php } ?>
                    <?php if ($modern_compare_top != 1) { ?>
                        <li class="marg_link"><a href="<?php echo $compare; ?>" id="compare-total"
                                                 title="<?php echo $text_compare; ?>"><i
                                class="fa fa-exchange hidden-lg hidden-md"></i> <span
                                class="hidden-xs hidden-sm "><?php echo $text_compare; ?></span></a></li><?php } ?>
                    <?php if ($modern_top_links6) { ?>
                        <?php foreach ($modern_top_links6 as $modern_top_link6) { ?>
                            <li>
                                <a <?php if ($modern_top_link6['link_top'][$language_id]) { ?> href="<?php echo $modern_top_link6['link_top'][$language_id]; ?>"<?php } ?>
                                    title="<?php echo $modern_top_link6['title'][$language_id]; ?>"><?php if ($modern_top_link6['faicons_top']) { ?>
                                    <i class="<?php echo $modern_top_link6['faicons_top']; ?> hidden-lg hidden-md"></i><?php } ?><?php if ($modern_top_link6['title']) { ?>
                                        <span
                                            class="hidden-xs hidden-sm "> <?php echo $modern_top_link6['title'][$language_id]; ?></span><?php } ?>
                                </a>
                            </li>
                        <?php } ?>
                    <?php } ?>
            ...
            <div id="top-links" class="nav pull-right">
                <ul class="list-inline top">
                    <?php if ($modern_account_top != 1) { ?>
                                    ...
                                    <li class="dropdown"><a href="<?php echo $account; ?>"
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <?php if ($logged) { ?>
                                                ...
                                                <?php if ($modern_order_top != 1) { ?>
                                                    <li><a href="<?php echo $order; ?>"><?php echo $text_order; ?></a>
                                                    </li><?php } ?>
                                                <?php if ($modern_transaction_top != 1) { ?>
                                                    <li><a
                                                        href="<?php echo $transaction; ?>"><?php echo $text_transaction; ?></a>
                                                    </li><?php } ?>
                                                <?php if ($modern_download_top != 1) { ?>
                                                    <li><a
                                                        href="<?php echo $download; ?>"><?php echo $text_download; ?></a>
                                                    </li><?php } ?>
                        ...
                        <?php } ?>
                    <?php } ?>
                    <?php if ($modern_cart_top != 1) { ?>
                        <li><a href="<?php echo $shopping_cart; ?>" title="<?php echo $text_shopping_cart; ?>"><i
                                class="fa fa-shopping-cart hidden-lg hidden-md"></i> <span
                                class="hidden-xs hidden-sm "><?php echo $text_shopping_cart; ?></span></a>
                        </li><?php } ?>
                    <?php if ($modern_checkout_top != 1) { ?>
                        <li><a href="<?php echo $checkout; ?>" title="<?php echo $text_checkout; ?>"><i
                                class="fa fa-share hidden-lg hidden-md"></i> <span
                                class="hidden-xs hidden-sm "><?php echo $text_checkout; ?></span></a></li><?php } ?>
                </ul>
            </div>
        </div>
    </nav>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        <div class="row height_search_tel">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="listunstyled"><span
                                                        class="tell_nav"><?php echo $modern_telephone_mainheader2[$language_id]; ?></span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?php if ($modern_top_links3 || $modern_top_links5 || $modern_mail_header[$language_id]) { ?>
                                                    <div class="dropdown">
                                                        <div class="listunstyled dropdown-toggle"
                                                             data-toggle="dropdown"><span
                                                                class="tell_nav"><?php echo $modern_telephone_mainheader[$language_id]; ?></span><b
                                                                class="caret"></b></div>
                                                        <ul class="dropdown-menu fixxsmenu">
                                                            <?php if ($modern_top_links3) { ?>
                                                                <?php foreach ($modern_top_links3 as $modern_top_link3) { ?>
                                                                    <li>
                                                                        <div
                                                                            class="drop_head_first"><?php echo $modern_top_link3['name'][$language_id]; ?></div>
                                                                        <a <?php if ($modern_top_link3['title'][$language_id]) { ?> href="tel:<?php echo $modern_top_link3['title'][$language_id]; ?>"<?php } ?> ><?php if ($modern_top_link3['faicons_top']) { ?>
                                                                                <i
                                                                                class="<?php echo $modern_top_link3['faicons_top']; ?>"></i><?php } ?> <?php echo html_entity_decode($modern_top_link3['title'][$language_id], ENT_QUOTES, 'UTF-8'); ?>
                                                                        </a>
                                                                    </li>
                                                                <?php } ?>
                                                            <?php } ?>
                                                            <?php if ($modern_top_links5) { ?>
                                                                <?php foreach ($modern_top_links5 as $modern_top_link5) { ?>
                                                                    <li>
                                                                        <div
                                                                            class="drop_head"><?php echo $modern_top_link5['name'][$language_id]; ?></div>
                                                                        <a <?php if ($modern_top_link5['title'][$language_id]) { ?> href="callto:<?php echo $modern_top_link5['title'][$language_id]; ?>"<?php } ?> ><?php if ($modern_top_link5['faicons_top']) { ?>
                                                                                <i
                                                                                class="<?php echo $modern_top_link5['faicons_top']; ?>"></i><?php } ?> <?php echo html_entity_decode($modern_top_link5['title'][$language_id], ENT_QUOTES, 'UTF-8'); ?>
                                                                        </a>
                                                                    </li>
                                                                <?php } ?>
                                                            <?php } ?>
                                                            <?php if ($modern_mail_header[$language_id]) { ?>
                                                                <li>
                                                                    <div
                                                                        class="drop_head"><?php echo $modern_tittle_name[$language_id]; ?></div>
                                                                    <a onClick="javascript:window.open('mailto:<?php echo $modern_mail_header[$language_id]; ?>', 'Mail');event.preventDefault()"
                                                                       href="<?php echo $modern_mail_header[$language_id]; ?>"><i
                                                                            class="fa fa-envelope-o "></i> <?php echo $modern_mail_header[$language_id]; ?>
                                                                    </a></li>
                                                            <?php } ?>
                                                            <li>
                                                                <?php if ($aridiuscallback_status && $modern_calltop != 1) { ?>
                                                                    <div class="drop_head"></div>
                                                                    <a class="call-order"><i
                                                                            class="<?php echo $modern_top_link3['faicons_top']; ?>"></i>&nbsp;<?php echo $button_title; ?>
                                                                    </a>
                                                                <?php } ?>
                                                            </li>
                                                        </ul>
                                                ...
                                                <?php } else { ?>
                                                    <div class="phone">
                                                        <div class="listunstyled btn-lg"><span
                                                                class="tell_nav"><?php echo $modern_telephone_mainheader[$language_id]; ?></span>
                                                        </div>
                                                    </div>
                                                <?php } ?></td>
                                        </tr>
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 head_search">
                                <button class="button_title input-group" data-callback="on">&nbsp;Заказать обратный
                                    звонок
                                </button>
                            </div>
                                            ...
                                            <ul class="nav navbar-nav">
                                                ...
                                                <?php if ($modern_seevmenu_menu != 1) { ?>
                                                    <li class="dropdown hidev"><a
                                                            class="with-child dropdown-toggle" <?php if (!empty($modern_link_menucatalog)) { ?> href="<?php echo $modern_link_menucatalog; ?>" <?php } ?>
                                            ...
                                            <div class="menu_mob_plus">
                                                    ...
                                                    <ul class="nav navbar-nav">
                                                        <?php foreach ($categories as $category) { ?>
                                                            <?php if ($category['children']) { ?>
                                                                ...
                                                                <li class="<?php if ($category['category_id'] == $category_id) {
                                                                    echo 'activetopmenu';
                                                                } ?> dropdown">
                                                                    <a class="with-child dropdown-toggle"
                                                ...
                                                <ul class="nav navbar-nav">
                                                    ...
                                                    <?php if ($modern_main_link_menu[$language_id]) { ?>
                                                        <li class="plus"><i class="fa fa-plus"></i><i
                                                                class="fa fa-minus"></i></li>
                                                        <li class="dropdown"><a class="with-child dropdown-toggle"
                                                    ...
                                                    <?php if ($modern_man_menu != 1) { ?>
                                                        <?php if ($manufacturers) { ?>
                                                            <li class="plus"><i class="fa fa-plus"></i><i
                                                                    class="fa fa-minus"></i></li>
                                                            <li class="dropdown manuf_drop"><a
