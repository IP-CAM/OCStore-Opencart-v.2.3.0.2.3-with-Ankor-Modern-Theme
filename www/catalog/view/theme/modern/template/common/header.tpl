...
<?php if ($modern_wishlist_top !=1) { ?><li class="marg_link"><a href="<?php echo $wishlist; ?>" id="wishlist-total" title="<?php echo $text_wishlist; ?>"><i class="fa fa-heart hidden-lg hidden-md"></i> <span class="hidden-xs hidden-sm "><?php echo $text_wishlist; ?></span></a></li><?php } ?>
<?php if ($modern_compare_top !=1) { ?><li class="marg_link"><a href="<?php echo $compare; ?>" id="compare-total" title="<?php echo $text_compare; ?>"><i class="fa fa-exchange hidden-lg hidden-md"></i> <span class="hidden-xs hidden-sm "><?php echo $text_compare; ?></span></a></li><?php } ?>
<?php if ($modern_top_links6 ) { ?>
	<?php foreach ($modern_top_links6 as $modern_top_link6) { ?>
		<li>
		<a <?php if ($modern_top_link6['link_top'][$language_id]) { ?> href="<?php echo $modern_top_link6['link_top'][$language_id]; ?>"<?php } ?> title="<?php echo $modern_top_link6['title'][$language_id]; ?>"><?php if ($modern_top_link6['faicons_top']) { ?> <i class="<?php echo $modern_top_link6['faicons_top']; ?> hidden-lg hidden-md"></i><?php } ?><?php if ($modern_top_link6['title']) { ?><span class="hidden-xs hidden-sm "> <?php echo $modern_top_link6['title'][$language_id]; ?></span><?php } ?></a>
		</li>
		<?php } ?>
	<?php } ?>
</ul>
...
<?php if (!$modern_header_var) { ?>
	...
	<?php if ($modern_telephone_mainheader2[$language_id] || $modern_telephone_mainheader[$language_id]) { ?>
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 head_search">
			<button class="button_title input-group">&nbsp;Заказать обратный звонок</button>
		</div>
