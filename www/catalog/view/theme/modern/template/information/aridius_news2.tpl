...
<?php if (isset($aridius_news_info)) { ?>
	...
	<br />
	<?php if ($aridius_news2_status_review !=1) { ?>
		<!-- Main form -->
	...
	<?php if ($aridius_news2) { ?>
		...
		<div class = "padding-carusel row">
		<div class = "relatedn owl-carousel">
		<?php foreach ($aridius_news2 as $new) { ?>
			<?php $id_video;?>
			...
			<?php if (!$aridius_news2_show_date) { ?>
				<i class="fa fa-clock-o"></i> <span class="posted-aridius_news2"><?php echo $new['posted']; ?></span>
				<?php } ?>
	...
	<br />
	<div class="row">
	<?php foreach ($aridius_news_data as $aridius_news2) { ?>
		<?php $id_video;?>
		<?php $str=strpos($aridius_news2['video'], "="); ?>
		<?php if ($str) { ?>
			<?php $str_end=strpos($aridius_news2['video'], "&"); ?>
			<?php if ($str_end) { ?>
				<?php $id_video = substr($aridius_news2['video'], $str+1 ,$str_end - $str-1); ?>
				<?php } else { ?>
				<?php $id_video = substr($aridius_news2['video'], $str+1); ?>
				<?php } ?>
			<?php } ?>
		<div class="product-layoutcat product-grid col-lg-3 col-md-3 col-sm-4 col-xs-6 cat_news">
		<div class="product-thumb">
		<?php if ($aridius_news2['video']) { ?>
			<div class="fixnewsgrid video_cat"><iframe class="embed-responsive-item" src="https://www.youtube.com/embed/<?php echo $id_video; ?>" allowfullscreen></iframe></div>
			<?php } else { ?>
			<div class="image fixnewsgrid"><a href="<?php echo $aridius_news2['href']; ?>" title="<?php echo $aridius_news2['title']; ?>"><img src="<?php echo $aridius_news2['thumb']; ?>" alt="<?php echo $aridius_news2['title']; ?>" class="img-responsive" /></a>	</div>
			<?php } ?>
		<div class="list_block">
		<div class="caption caption-left">
		<?php if (!$aridius_news2_show_date) { ?>
			<i class="fa fa-clock-o"></i> <span class="posted-aridius_news2"><?php echo $aridius_news2['posted']; ?></span>
			<?php } ?>
		<h4 class="news_hr"><a href="<?php echo $aridius_news2['href']; ?>"><?php echo $aridius_news2['title']; ?></a></h4>
		<p class="newsdesc"><?php echo $aridius_news2['description']; ?></p>
		<p><a href="<?php echo $aridius_news2['href']; ?>"><i class="fa fa-link"></i> <span class ="morecolor"><?php echo $text_more; ?></span></a></p>
		</div>
		</div>
		</div>
		</div>
...
<?php if (!isset($aridius_news_data)) { ?>
	...
	$('#review_news').load('index.php?route=information/aridius_news2/review&aridius_news_id2=<?php echo $aridius_news_id2; ?>');
	$(document).on('submit','form.review_news-form',function(e){
		e.preventDefault();
		var $this=$(this);
		$.ajax({
url: 'index.php?route=information/aridius_news2/write&aridius_news_id2=<?php echo $aridius_news_id2; ?>',
type: 'post',
dataType: 'json',
data: $this.serialize(),
beforeSend: function () {
...
success: function (json) {
	...
	$(document).on('click', '.comment-reply', function () {
		var $this=$(this);
		$.post( "index.php?route=information/aridius_news2/reply", { parent: $this.attr("data-parent") }, function( data ) {
			$('.reply-form').remove();
