...
class ControllerExtensionModuleAridiusinstock extends Controller {
	...
	public function index() {
		...
		if ($this->config->get('aridiusinstock_status')) {
			...
			$this->document->addStyle('catalog/view/theme/modern/stylesheet/aridiusinstock.css');	
			$this->document->addScript('catalog/view/theme/modern/js/aridius/aridius_instock.js');		
