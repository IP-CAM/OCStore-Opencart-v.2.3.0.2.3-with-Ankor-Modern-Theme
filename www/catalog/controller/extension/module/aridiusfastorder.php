...
class ControllerExtensionModuleAridiusfastorder extends Controller {
	...
	public function index() {
		...
		if ($this->config->get('aridiusfastorder_status')) {
			...
			$this->document->addStyle('catalog/view/theme/modern/stylesheet/aridiusfastorder.css');	
			$this->document->addScript('catalog/view/theme/modern/js/aridius/aridius_fastorder.js');		
