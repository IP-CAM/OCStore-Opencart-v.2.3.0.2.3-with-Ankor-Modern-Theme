...
class ControllerExtensionModuleAridiusundersell extends Controller {
	...
	public function index() {
		...
		if ($this->config->get('aridiusundersell_status')) {
			...
			$this->document->addStyle('catalog/view/theme/modern/stylesheet/aridiusundersell.css');	
			$this->document->addScript('catalog/view/theme/modern/js/aridius/aridius_undersell.js');		
